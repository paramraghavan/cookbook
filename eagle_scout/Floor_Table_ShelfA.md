...
Attaching a vertical 1x2 pine board (cut to the full 60.25" length) flush under the front edge creates an upside-down "
L" beam that eliminates sagging under heavy chemistry gear.
...
```text
                    SIDE VIEW (Looking down the side edge of the shelf)
                       ...
                       Front Edge                               Back Edge
                            ...
                            v                                       v
                    +---------------+---------------------------------------+
                    |               3/4" Plywood Long Shelf                 |  <-- Horizontal top
                    +-------+-------+---------------------------------------+
                            |       |
                            | 1x2   |
                            | Lip   |  <-- Vertical leg (hangs down 1.5 inches;
                            |       |      aligned flush with front edge)
                            +-------+
...
```text
LEFT SECTION WALLS (Inside Left Side Panel & Left Face of Center Divider)
+-------------------------------------------------------------------------+ (Top Edge: 22.5" High)
|                                                                         |
|       [===================== Cleat 3 =====================]             | <-- Top edge at 16.5"
|                                                                         |
|       [===================== Cleat 2 =====================]             | <-- Top edge at 11.0"
|                                                                         |
|       [===================== Cleat 1 =====================]             | <-- Top edge at 5.5"
|                                                                         |
+-------------------------------------------------------------------------+ (Bottom Edge)
| 3.25" Gap |<------------------- 20.0" Long Cleat ---------------------->|
 (Front Edge)                                                              (Back Edge)

RIGHT SECTION WALLS (Right Face of Center Divider & Inside Right Side Panel)
+-------------------------------------------------------------------------+ (Top Edge: 22.5" High)
|                                                                         |
|       [===================== Long Shelf Cleat ============]             | <-- Top edge at 14.5"
|                                                                         |
+-------------------------------------------------------------------------+ (Bottom Edge)
| 3.25" Gap |<------------------- 20.0" Long Cleat ---------------------->|
...
```text
                       ======================================= [Top Panel: 92" x 23.25"]
                      ||                                     ||
   +------------------++--------------------+----------------++-------------------+
   |                  ||   Small Shelf 1    |                ||                   |
   |                  ||====================|                ||   Long Shelf      |
   |   Left Side      || [Cleat]   [Cleat]  ||   Center       ||===================| <-- [1x2 Stiffener Lip]
   |   Panel          ||   Small Shelf 2    |   Divider      || [Cleat]   [Cleat] |
   | (22.5" x 23.25") ||====================| (22.5"x23.25") ||                   |
   |                  || [Cleat]   [Cleat]  ||                ||   Right Side      |
   |                  ||   Small Shelf 3    |                ||   Panel           |
   |                  ||====================|                || (22.5" x 23.25")  |
   |                  || [Cleat]   [Cleat]  ||                ||                   |
   +------------------++--------------------+----------------++-------------------+
                      ||                                     ||
                       ======================================= [Bottom Panel: 92" x 23.25"]
                           | |                   | |                 | |
                          [2x4]                 [2x4]               [2x4]  <-- [2x4 Base Elevation Skids]
...
1. Take your $60.25''$ Long Shelf and lay it flat on your workbench bottom-side up.
2. Cut a piece of 1x2 pine board to **exactly $60.25''$ long** so it spans the complete width of the shelf.
3. Align the 1x2 board on its narrow edge **flush against the front edge** on the underside of the shelf (forming an
   inverted "L" beam profile).
4. Apply wood glue along the contact joint, clamp in place, and drive **1-1/4" to 1-1/2" finish nails** (or pre-drill
   with a 1/8" countersink bit and drive 1-1/4" wood screws) vertically down through the top face of the shelf into the
   stiffener bar every 6 to 8 inches. Wipe away glue squeeze-out.

#### Step 2: Attach 2x4 Base Skids (Floor Water & Moisture Protection)

1. Lay the **Bottom Panel** ($92'' \times 23.25''$) flat on the floor face down.
2. Cut three $23.25''$ long 2x4 pieces (Base Skids). Place one flush at the far left edge, one in the exact middle under
   the center divider line, and one flush at the far right edge (running front-to-back).
3. Apply wood glue between the skids and plywood. Pre-drill with your 1/8" countersink bit and drive **2" #8 wood screws
   ** through the bottom panel into the 2x4 skids (4 screws per skid).
4. *Function:* Elevates the bottom plywood panel 1.5" off damp chemistry lab floors, preventing mopping water, puddles,
   and chemical cleaners from soaking into the wood core while making the unit easier to slide.

#### Step 3: Mount Side Support Cleats (The Easy Assembly Method)

1. Measure from the bottom edge of your vertical wall panels (inside faces only—**no wall mounting to room walls**) and
   draw horizontal guidelines:

* **Left Side Panel & Left Face of Center Divider:** Draw lines at **$5.5''$**, **$11.0''$**, and **$16.5''$** from the
  bottom.
* **Right Side Panel & Right Face of Center Divider:** Draw a line at **$14.5''$** from the bottom.


2. Position a $20''$ long 1x2 cleat *just below each line*, pushing the cleat flush against the rear edge (leaving
   a $3.25''$ space at the front).
3. Apply wood glue behind each cleat, pre-drill pilot holes, and secure with **1-1/4" finish nails or 1-1/4" wood screws
   ** (3 fasteners per cleat).

#### Step 4: Assemble Interior Shelves & Frame (Dual-Fastening Method)

1. Stand the **Left Side Panel**, **Center Divider**, and **Right Side Panel** vertically.
2. Slide the 3 Small Shelves ($29.5''$) and 1 Long Shelf ($60.25''$) into position so they rest directly on top of the
   mounted interior support cleats.
...
* **Vertical Cleat Fastening:** Drive **1-1/4" to 1-1/2" finish nails** (or 1-1/4" screws) vertically down through the
  top face of the shelf into the 1x2 support cleats below (3 fasteners per cleat).
* **Horizontal Side Fastening:** Drive **1-1/2" to 2" finish nails** (or 1-5/8" trim screws) horizontally through the
  exterior side panels and center divider directly into the center edge cores of the shelf boards (2–3 fasteners per
  shelf side).

#### Step 5: Attach Top, Bottom & Back Panels (Free-Standing Rigidity)

1. Apply wood glue to all top edges of the assembled vertical walls.
2. Place the **Top Panel** ($92'' \times 23.25''$) squarely on top, pre-drill, and secure with **2" wood screws** into
   the vertical panel edges (3 screws per wall).
3. Apply glue to all bottom edges, set the frame onto the **Bottom Panel** (with attached 2x4 skids), and secure with *
   *2" wood screws** driven from inside down into the bottom panel.
...
6. Set the **Back Panel** ($92'' \times 24''$) flush over the rear face. Pre-drill and drive **1" to 1-1/4" brad nails
   or screws** every 6 to 8 inches around the perimeter and center divider. *This rear panel locks the frame square and
   provides the structural stability required so the shelf stays completely rigid without any wall mounting.*
